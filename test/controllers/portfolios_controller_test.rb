...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference("Portfolio.count") do
      post portfolios_url, params: { portfolio: { money: @portfolio.money, private: @portfolio.private, user_id: @portfolio.user_id } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { money: @portfolio.money, private: @portfolio.private, user_id: @portfolio.user_id } }
